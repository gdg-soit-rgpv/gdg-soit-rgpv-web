            ...
            <div className="flex-1 w-full">
                <div className="grid grid-cols-2 gap-6">
                    <div className="bg-white p-8 rounded-3xl shadow-sm border border-neutral-100">
                        <div className="text-5xl font-bold text-neutral-900 mb-2">500+</div>
        ...
        <section className="py-24 px-6 bg-black text-white rounded-t-[3rem] md:rounded-t-[5rem]">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button className="px-8 py-4 border border-neutral-700 text-white rounded-full font-bold text-lg hover:bg-neutral-900 transition-colors">
